    ...
    <section className="pt-32 sm:pt-48 pb-20" ref={ref}>
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        >
          <a
            href="#services"
            className="px-6 py-3 rounded-full bg-primary text-white hover:bg-secondary focus:bg-secondary transition"
          >
            Explore Services
          </a>
          <a
            href="#about"
            className="px-6 py-3 rounded-full border border-primary text-primary hover:bg-primary hover:text-white focus:bg-primary transition"
          >
            Learn More
          </a>
        </motion.div>
