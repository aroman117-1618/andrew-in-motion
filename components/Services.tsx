  ...
  return (
    <section id="services" className="section">
      <div className="glass p-8 md:p-10">
        ...
        <p className="section-sub font-medium leading-relaxed text-brand-emerald italic">Two ways to engage, endless ways to deliver. Simple hourly pricing + tailored scopes to fit your growth stage.</p>
