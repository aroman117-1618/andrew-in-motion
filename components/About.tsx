        ...
        <div className="mt-6 grid gap-8 md:grid-cols-2 text-white/85">
          <div className="space-y-6">
            <p className="text-lg">
              ...
              evolve teams, and surface real customer signals.
            </p>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2">
                <li>
                  • <b>Lifecycle Design:</b> programming that drives expansion &amp; retention
                  from pre-sale through renewal.
                </li>
                <li>
                  • <b>System Automation:</b> workflows that accelerate revenue, cut wasted
                  hours, and raise data quality.
                </li>
                <li>
                  • <b>Data-driven Storytelling:</b> turn signals into strategy that scales
                  revenue.
                </li>
              </ul>
            </div>
