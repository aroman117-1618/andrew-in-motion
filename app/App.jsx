...
import AuroraField from "./components/AuroraField.jsx"; // ⟵ NEW
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#141414] text-zinc-100">
      {/* === NEW: Aurora background behind everything === */}
      <AuroraField
        strength={0.78}             // overall intensity
        speed={0.075}               // animation speed
        grain={0.04}                // subtle film grain
        mousePull={0.50}            // reach toward pointer
        pulseDecay={1.8}            // click pulse fade rate
        palette={[
          [17, 41, 23],             // pine
          [28, 139, 102],           // emerald
          [59, 98, 85],             // deep
          [155, 194, 96],           // lime glow
        ]}
      />
      {/* ================================================= */}
          ...
          <CardContent>
            ...
            <div className="mt-5 rounded-xl border border-zinc-800 p-4">
              <ul className="space-y-2 text-base leading-relaxed text-zinc-200">
                ...
                <li className="grid grid-cols=[auto,1fr] items-start gap-x-3 sm:grid-cols-[auto,1fr]">
                  <a
